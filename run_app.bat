...
!PY_CMD! -c "import streamlit; import firebase_admin; import sqlalchemy; import pandas; import playwright; import bs4; import google.cloud.firestore; import pypdf; import airportsdata" >nul 2>&1
if !ERRORLEVEL! neq 0 (
